            ...
            <span className='skills-subtitle'>Tecnologías y librerías</span>
                <ul className='skills-img_list grid-container'>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/Javascript.webp" alt="" />
                        <p className='skills-img_text'>Javascript</p>
                    </li>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/node.webp" alt="node js" />
                        <p className='skills-img_text'>Node Js</p>
                    </li>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/express.webp" alt="Express Js" />
                    ...
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/postgresql.webp" alt="" />
                        <p className='skills-img_text'>PostgreSQL</p>
                    </li>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/jest.webp" alt="" />
                        <p className='skills-img_text'>Jest</p>
                    </li>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/Bcrypt.webp" alt="" />
                        <p className='skills-img_text'>Bcrypt</p>
                    </li>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/supertest.webp" alt="" />
                        <p className='skills-img_text'>Supertest</p>
                    </li>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/nodemailer.webp" alt="" />
                        <p className='skills-img_text'>Nodemailer</p>
                    </li>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/Html.webp" alt="" />
                        <p className='skills-img_text'>Html</p>
                    </li>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/Css.webp" alt="" />
                        <p className='skills-img_text'>Css</p>
                    </li>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/React.webp" alt="" />
                        <p className='skills-img_text'>React</p>
                    </li>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/Redux.webp" alt="" />
                        <p className='skills-img_text'>Redux</p>
                    </li>
                    <li className='skills-img_items flex-container'>
                        <img className='skills-img' src="/public/img/React-router.webp" alt="" />
